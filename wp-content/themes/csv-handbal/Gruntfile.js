...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      dist: {
        src: ['src/bower_components/Headhesive.js/dist/headhesive.js', 'src/bower_components/flickity/dist/flickity.pkgd.min.js', 'src/bower_components/smooth-scroll/dist/js/smooth-scroll.js', 'src/scripts/main.js'],
    ...
    watch: {
      ...
      php: {
        files: ['src/*.php'],
        tasks: [''], //to-do: add and configure php lint for grunt
        options: {
          spawn: false,
          livereload: true,
        },
